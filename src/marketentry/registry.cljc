(ns marketentry.registry
  ...
  call to any real procurement portal (Portal javnih nabavki). It
...
(defn register-draft
  ...
  market-entry operator's own act of preparing a Portal javnih nabavki
  registration package. Pure function -- does not touch any real
  procurement portal."
...
(defn register-submit
  ...
  javnih nabavki registration (always human-gated upstream)."
  [engagement-id jurisdiction sequence]
  (when-not (and engagement-id (not= engagement-id ""))
